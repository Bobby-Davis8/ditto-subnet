...
describe('Backroom MCP tools', () => {
  ...
  it('publishes every Backroom operation with MCP safety annotations', async () => {
    ...
    // Four benchmark canary operations add explicit lease identity/digest/CAS
    // inputs; measured catalog is 133,733 bytes. Descriptions remain short
    // summaries.
    ...
    // team-canary read (list_team_canaries) fits under that bound.
