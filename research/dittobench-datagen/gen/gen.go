...
func ProfileForVersion(runSize string, benchVersion int) (Profile, bool) {
	...
	case protocol.BenchVersionV9:
		profiles = profilesV9
	case protocol.BenchVersionV10, protocol.BenchVersionV11, protocol.BenchVersionV12, protocol.BenchVersionV13:
		// v11, v12, and v13 keep v10's run-size envelopes; their difficulty comes
