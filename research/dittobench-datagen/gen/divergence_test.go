...
func TestParserDivergenceTrapGrades(t *testing.T) {
	for seed := int64(1); seed <= 30; seed++ {
		cases, pairs := buildParserDivergence(seed, 12, protocol.BenchVersionV12)
...
func TestParserDivergenceIsWireOpaque(t *testing.T) {
	cases, _ := buildParserDivergence(123456789, 12, protocol.BenchVersionV12)
...
func TestParserDivergenceDeterministic(t *testing.T) {
	for _, seed := range []int64{1, 42, 123456789} {
		a, ap := buildParserDivergence(seed, 12, protocol.BenchVersionV12)
		b, bp := buildParserDivergence(seed, 12, protocol.BenchVersionV12)
